...
class GameScene extends Phaser.Scene {
  ...
  create() {
    ...
    let labirinth = this._renderLabyrinth(tiles, width, height, x, y);
    // this.labirinth = labirinth;
    this.physics.add.collider(this.player, labirinth);

    // let player = labirinth.physics.add.sprite(50, 50, 'cat');
